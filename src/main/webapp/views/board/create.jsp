			...
			<div class="register_book_form">
				<form action='/book/createEnd' name="create_board_form"
					...
					<br> <input type="text" name="board_content"
						placeholder="내용을 입력하세요."><br> <input type="text"
						name="board_writer" placeholder="작성자를 입력하세요."> <br> <input
						type="file" name="thumbnail" accept=".png, .jpg, .jpeg"><br>
